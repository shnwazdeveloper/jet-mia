...
class _TranslationsWebSharePagePl extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'Jet Mia używa samopodpisanego certyfikatu. Musisz go zaakceptować w przeglądarce.';
  @override
...
class _TranslationsAboutPagePl extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'O Jet Mia';
  @override
  List<String> get description => [
    'Jet Mia jest darmową, otwartoźródłową aplikacją, która pozwala na bezpieczne udostępnianie plików i wiadomości urządzeniom w pobliżu poprzez Twoją sieć lokalną, bez konieczności połączenia z internetem.',
...
class _TranslationsDonationPagePl extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'Jet Mia jest darmową, otwartoźródłową aplikacją bez żadnych reklam. Jeśli podoba Ci się aplikacja, możesz wesprzeć jej rozwój darowizną.';
  @override
...
class _TranslationsTrayPl extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Zakończ Jet Mia';
  @override
...
class _TranslationsNetworkInterfacesPagePl extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Domyślnie Jet Mia używa wszystkich dostępnych interfejsów sieciowych. Możesz tutaj wykluczyć niechciane sieci. Musisz ponownie uruchomić serwer, aby zastosować zmiany.';
}
...
class _TranslationsSettingsTabGeneralPl extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Pokaż Jet Mia w menu kontekstowym';
  @override
...
class _TranslationsSettingsTabOtherPl extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Wesprzyj Jet Mia';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedPl extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'Jet Mia nie może znaleźć innych urządzeń bez uprawnienia do skanowania sieci lokalnej. Udziel tego uprawnienia w ustawieniach.';
  @override
...
class _TranslationsDialogsSendModeHelpPl extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Odbiorcy, którzy nie mają zainstalowanego Jet Mia, mogą pobrać wybrane pliki, otwierając link w swojej przeglądarce.';
}
