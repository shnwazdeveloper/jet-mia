...
class _TranslationsReceiveOptionsPageBg extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(папка на Jet Mia)';
  @override
...
class _TranslationsWebSharePageBg extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'Jet Mia използва самоподписан сертификат. Трябва да го приемете във вашия браузър.';
  @override
...
class _TranslationsAboutPageBg extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'Относно Jet Mia';
  @override
  List<String> get description => [
    'Jet Mia е безплатно приложение с отворен код, което ви позволява сигурно да споделяте файлове и съобщения с устройства наблизо през вашата локална мрежа, без да се нуждаете от интернет връзка.',
...
class _TranslationsDonationPageBg extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'Jet Mia е безплатен, с отворен код и без никакви реклами. Ако харесвате приложението, можете да подкрепите разработката с дарение.';
  @override
...
class _TranslationsTrayBg extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Излезте от Jet Mia';
  @override
...
class _TranslationsNetworkInterfacesPageBg extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'По подразбиране, Jet Mia използва всички налични мрежови интерфейси. Тук можете да изключите нежелани мрежи. Трябва да рестартирате сървъра, за да приложите промените.';
}
...
class _TranslationsSettingsTabGeneralBg extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'Покажи Jet Mia в контекстното меню';
  @override
...
class _TranslationsSettingsTabOtherBg extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Поддръжка на Jet Mia';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedBg extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'Jet Mia не може да намери други устройства без разрешение за сканиране на локалната мрежа. Моля, предоставете това разрешение в настройките.';
  @override
...
class _TranslationsDialogsSendModeHelpBg extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Получателите, които нямат инсталиран Jet Mia, могат да изтеглят избраните файлове, като отворят връзката в своя браузър.';
}
