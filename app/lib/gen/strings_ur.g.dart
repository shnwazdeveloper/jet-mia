...
class _TranslationsWebSharePageUr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'Jet Mia براؤزر میں استعمال کرنے کیلئے آپ کوخود سائن کردہ سرٹیفکیٹ قبول کرنا ہوگا۔';
  @override
...
class _TranslationsAboutPageUr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'کے بارے میں Jet Mia';
  @override
  List<String> get description => [
    'Jet Mia ایک مفت، اوپن سورس ایپ ہے جو آپ کو انٹرنیٹ کنکشن کی ضرورت کے بغیر اپنے مقامی نیٹ ورک کے ذریعے قریبی آلات کے ساتھ فائلیں اور پیغامات محفوظ طریقے سے شیئر کرنے کی اجازت دیتی ہے۔',
...
class _TranslationsDonationPageUr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'Jet Mia مفت، اوپن سورس ہے اور اس میں کوئی اشتہارات نہیں ہیں۔ اگر آپ کو ایپ پسند ہے، تو آپ عطیہ کے ذریعے ترقی کی حمایت کر سکتے ہیں۔';
  @override
...
class _TranslationsTrayUr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'چھوڑو Jet Mia';
  @override
...
class _TranslationsSettingsTabGeneralUr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'سیاق و سباق کے مینو میں Jet Mia دکھائیں';
  @override
...
class _TranslationsSettingsTabOtherUr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Jet Mia کی حمایت کریں';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedUr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'لوکل نیٹ ورک کا سکین کرنے کی اجازت کے بغیر Jet Mia، دیگر ڈیوائسز تلاش نہیں کرسکتا ہے۔ براہ کرم ترتیبات میں اس اجازت کو منظور کریں۔';
  @override
...
class _TranslationsDialogsSendModeHelpUr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'Jet Mia نصب نہیں ہونے والے رسیورز منتخب شدہ فائلز کو لنک اپنے براؤزر میں کھولنے سے ڈاؤن لوڈ کر سکتے ہیں۔';
}
