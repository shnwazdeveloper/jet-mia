...
class _TranslationsReceiveOptionsPageAr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(مجلد Jet Mia)';
  @override
...
class _TranslationsWebSharePageAr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'يستخدم تطبيق Jet Mia شهادة موقع ذاتية التوقيع. يجب عليك قبولها في المتصفح.';
  @override
...
class _TranslationsAboutPageAr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'عن Jet Mia';
  @override
  List<String> get description => [
    'Jet Mia هو تطبيق مجاني مفتوح المصدر يسمح لك بمشاركة الملفات والرسائل بشكل آمن مع الأجهزة القريبة عبر شبكتك المحلية دون الحاجة إلى اتصال بالإنترنت.',
...
class _TranslationsDonationPageAr extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'Jet Mia مجاني ومفتوح المصدر وبدون أي إعلانات. إذا أعجبك التطبيق، يمكنك دعم التطوير بالتبرع.';
  @override
...
class _TranslationsNetworkInterfacesPageAr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'بشكل افتراضي، يستخدم Jet Mia جميع واجهات الشبكة المتاحة. يمكنك استبعاد الشبكات غير المرغوب فيها هنا. تحتاج إلى إعادة تشغيل الخادم لتطبيق التغييرات.';
  @override
  String get preview => 'معاينة';
}
...
class _TranslationsSettingsTabGeneralAr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'إظهار Jet Mia في قائمة السياق';
  @override
...
class _TranslationsSettingsTabOtherAr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'دعم Jet Mia';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedAr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'لا يمكن ل Jet Mia العثور على الأجهزة الأخرى بدون الإذن بفحص الشبكة المحلية. يُرجى منح هذا الإذن في الإعدادات.';
  @override
...
class _TranslationsDialogsSendModeHelpAr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'يمكن للمستلمين الذين لا يحتوون على Jet Mia تنزيل الملفات المحددة عن طريق فتح الرابط في متصفحهم.';
}
