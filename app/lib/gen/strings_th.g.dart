...
class _TranslationsReceiveOptionsPageTh extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(โฟลเดอร์ของ Jet Mia)';
  @override
...
class _TranslationsWebSharePageTh extends TranslationsWebSharePageEn {
  ...
  String get encryptionHint =>
      'Jet Mia ใช้ใบรับรองอุปกรณ์จากเว็บเบราเซอร์ (self-signed certificate) คุณต้องกดยอมรับใบรับรองนี้ในเบราว์เซอร์บนอุปกรณ์ของคุณ';
  @override
...
class _TranslationsAboutPageTh extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'เกี่ยวกับ Jet Mia';
  @override
  List<String> get description => [
    'Jet Mia เป็นแอปโอเพ่นซอร์สที่คุณสามารถดาวน์โหลดมาใช้ได้ฟรีโดยไม่เสียค่าใช้จ่าย ซึ่งตัวแอปจะช่วยให้คุณสามารถแบ่งปันไฟล์และข้อความกับอุปกรณ์ใกล้เคียงได้อย่างปลอดภัยผ่านเครือข่ายท้องถิ่นที่เชื่อมต่อร่วมกันโดยไม่จำเป็นต้องเชื่อมต่ออินเทอร์เน็ต',
...
class _TranslationsDonationPageTh extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'Jet Mia เป็นแอปโอเพ่นซอร์สที่คุณสามารถดาวน์โหลดมาใช้ได้ฟรีโดยไม่เสียค่าใช้จ่ายหรือโฆษณาแฝง หากคุณชื่นชอบแอปนี้ คุณสามารถสนับสนุนการพัฒนาแอปได้ด้วยการบริจาคเงิน';
  @override
...
class _TranslationsTrayTh extends TranslationsTrayEn {
  ...
  @override
  String get close => 'ออกจากแอป Jet Mia';
  @override
...
class _TranslationsNetworkInterfacesPageTh extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'ตามค่าเริ่มต้น Jet Mia จะใช้อินเทอร์เฟซเครือข่ายที่มีอยู่ทั้งหมด คุณสามารถยกเว้นเครือข่ายที่ไม่ต้องการได้ที่นี่ คุณต้องรีสตาร์ทเซิร์ฟเวอร์เพื่อใช้การเปลี่ยนแปลง';
  @override
...
class _TranslationsSettingsTabGeneralTh extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'แสดง Jet Mia ในเมนูคลิกขวา';
  @override
...
class _TranslationsSettingsTabOtherTh extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'สนับสนุน Jet Mia';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedTh extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'Jet Mia ไม่สามารถค้นหาอุปกรณ์อื่นได้หากคุณไม่ให้สิทธิ์การสแกนเครือข่ายที่อุปกรณ์นี้กำลังเชื่อมต่ออยู่ โปรดอนุญาตให้สิทธิ์ในการสแกนนี้ในหน้าการตั้งค่า';
  @override
...
class _TranslationsDialogsSendModeHelpTh extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'ผู้รับที่ไม่ได้ติดตั้งแอป Jet Mia สามารถดาวน์โหลดไฟล์ที่เลือกไว้ในรายการได้โดยการเปิดลิงก์ในเบราว์เซอร์';
}
